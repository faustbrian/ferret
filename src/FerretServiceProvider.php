...
/**
 * Laravel service provider for the Ferret configuration package.
 *
 * Registers the FerretManager singleton and configuration. Integrates
 * Ferret with Laravel's service container for seamless dependency
...
{
    /**
     * Configure the package with commands and configuration files.
     *
     * Registers the package name, configuration file, and console commands
     * for encrypting, decrypting, and converting configuration files.
     *
     * @param Package $package The package instance to configure with commands and settings
     */
    ...
    /**
     * Register Ferret services in the container.
     *
     * Creates and binds the FerretManager singleton to the service container
     * with configuration options loaded from the application's configuration
     * repository. Supports customization of search places, search strategy,
     * stop directory, caching, and empty file handling.
     */
    #[Override()]
