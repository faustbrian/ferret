...
use Cline\Ferret\Exceptions\MissingAppKeyException;
...
final class ConfigEncryptCommand extends Command
{
     ...
     * none is provided.
     *
     * @param FerretManager $manager The Ferret manager instance for handling encryption
     *
     ...
     * @throws InvalidConfigurationException  If encryption fails or data is invalid
     ...
     * @throws InvalidConfigurationException  If encryption fails
     *
     * @return int Command exit status (SUCCESS or FAILURE)
     */
     ...
     * @param null|string   $glob      Optional glob pattern to filter files (e.g., *.json)
     *
     * @throws DirectoryNotFoundException    If the directory does not exist
     * @throws InvalidConfigurationException If encryption fails for any file
     *
     * @return int Command exit status (SUCCESS or FAILURE)
     */
