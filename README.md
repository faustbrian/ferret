...
// Search for configuration (checks multiple locations and formats)
$result = Ferret::search('myapp');

// Load a specific file
Ferret::load('/path/to/config.yaml', 'myapp');

// Access configuration with dot notation
$value = Ferret::get('myapp', 'database.host');

// Modify and save
Ferret::set('myapp', 'database.port', 5432);
Ferret::save('myapp');
```
