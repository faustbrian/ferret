 ...
 *
 * Occurs when attempting to load a configuration file that does not exist
 * at the specified path or is not accessible due to filesystem permissions.
 *
...
final class FileNotFoundException extends ConfigurationNotFoundException
{
     ...
     *
     * @param string $filepath Absolute or relative path to the configuration file that was not found
     */
